 <x-jet-dialog-modal wire:model="confirmingUpdating">
    ...
    <x-slot name="content">
        ...
        <div class="col-span-6 mb-4 sm:col-span-4">
            ...
            <x-jet-input id="start_date" onkeydown="return false" type="date" class="block w-full mt-1" required pattern="\d{4}-\d{2}-\d{2}" wire:model.defer="updateForm.start_date" />
        ...
        <div class="col-span-6 mb-4 sm:col-span-4">
            ...
            <x-jet-input-error for="updateForm.description" class="mt-2" />
        </div>
        ...
        <div class="col-span-6 mb-4 sm:col-span-4">
            ...
            <x-jet-input id="minimum_success_criteria" type="text" class="block w-full mt-1" wire:model.defer="updateForm.minimum_success_criteria" />
            <x-jet-input-error for="updateForm.minimum_success_criteria" class="mt-2" />
        </div>

        <div class="col-span-6 mb-4 sm:col-span-4">
            <x-jet-label for="sponsor" value="{{ __('Sponsor') }}" />
            <x-jet-input id="sponsor" type="text" class="block w-full mt-1" wire:model.defer="updateForm.sponsor" />
            <x-jet-input-error for="updateForm.sponsor" class="mt-2" />
        </div>

        <div class="col-span-6 mb-4 sm:col-span-4">
            <x-jet-label for="estimated_launch_date" value="{{ __('Estimated Launch Date') }}" />
            <x-jet-input id="estimated_launch_date" onkeydown="return false" type="date" class="block w-full mt-1" pattern="\d{4}-\d{2}-\d{2}" wire:model.defer="updateForm.estimated_launch_date" />
            <x-jet-input-error for="updateForm.estimated_launch_date" class="mt-2" />
        </div>
    </x-slot>
